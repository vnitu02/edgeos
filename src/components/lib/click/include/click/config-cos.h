/* include/click/config-cos.h.  Generated from config-cos.h.in by configure.  */
/* Process this file with configure to produce config-cos.h. -*- mode: c -*- */
#ifndef CLICK_CONFIG_COS_H
#define CLICK_CONFIG_COS_H
